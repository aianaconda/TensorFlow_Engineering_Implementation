...
inputs = tf.compat.v1.placeholder(tf.float32, (224, 224, 3))#定义占位符
...
with tf.compat.v1.Session() as sess:  #在session中运行
    sess.run(tf.compat.v1.global_variables_initializer())
    Reslayer = EfficientNetB0(weights='efficientnet-b0.h5')
